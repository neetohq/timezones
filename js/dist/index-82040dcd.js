  ...
  return /* @__PURE__ */ y(
    ...
    /* @__PURE__ */ y(
      ...
      /* @__PURE__ */ y("div", { className: "flex flex-row gap-x-2" }, /* @__PURE__ */ y(
        ...
        /* @__PURE__ */ y("span", null, selectedValue == null ? void 0 : selectedValue.label)
      ), isDST(selectedValue == null ? void 0 : selectedValue.utc[0]) && /* @__PURE__ */ y(
        "span",
        {
          "data-tooltip": "Daylight savings Time",
...
function Options({
  ...
  const handleSelect = (e2) => {
    ...
    const selectedTimezone = allTimezones.find((timezone) => (timezone == null ? void 0 : timezone.value) === targetValue);
  ...
  return /* @__PURE__ */ y("div", { className: "overflow-y-scroll h-80" }, /* @__PURE__ */ y("div", { className: "flex flex-col" }, createGroupedOptionButton(filterTimezones(searchInput), selectedValue, handleSelect)));
}
