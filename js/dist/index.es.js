...
const allTimezones$1 = groupedOptions$1.reduce((accumulator, currentValue) => {
  const key = Object.keys(currentValue)[0];
  return [...accumulator, ...currentValue[key]];
}, []);
const ianaTimezoneToHumanReadable = (ianaValue) => {
  const TimezoneObject = allTimezones$1.find((timezone) => timezone.utc.includes(ianaValue.utc[0]));
...
export {
  Plugin as NeetoTimezoneSelector,
